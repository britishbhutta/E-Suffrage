...
@php
    ...
    if($booking->media_ad_id){
        $apiStartTime = Carbon::parse('2025-10-22T14:30'); 
        $apiFinishTime = Carbon::parse('2025-10-24T14:30');
    }
@endphp
...
<form class="details-form reward-form" method="POST" action="{{ route('voting.create.step', ['step' => $currentStep]) }}" enctype="multipart/form-data" novalidate>
    ...
    <div class="row g-3">
        <div class="col-md-6">
            ...
            @if(isset($apiStartTime))
                <input type="datetime-local" class="form-control @error('start_at') is-invalid @enderror" id="start_at" name="start_at" required value="{{ $apiStartTime }}">
            @else
        ...
        <div class="col-md-6">
            ...
            @if(isset($apiFinishTime))
                <input type="datetime-local" class="form-control @error('end_at') is-invalid @enderror" id="end_at" name="end_at" required value="{{ $apiFinishTime }}">
            @else
