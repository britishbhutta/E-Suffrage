<x-guest-layout>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const rememberExpiration = localStorage.getItem('rememberExpiration');
        
        const sessionEmail = sessionStorage.getItem('tempEmail');
        const sessionPassword = sessionStorage.getItem('tempPassword');
        ...
        if (sessionEmail && sessionPassword) {
            ...
            document.getElementById('email').title = 'Credentials auto-filled from current session';
            document.getElementById('password').title = 'Password auto-filled from current session';
            
        } else if (rememberedEmail && rememberMe === 'true' && rememberExpiration) {
            const expirationDate = new Date(rememberExpiration);
            if (new Date() <= expirationDate) {
                ...
                document.getElementById('email').title = 'Email remembered from previous session';
            } else {
                clearRememberedData();
            }
        }
    ...
    function saveSessionCredentials(email, password) {
        sessionStorage.setItem('tempEmail', email);
        sessionStorage.setItem('tempPassword', password);
        sessionStorage.setItem('sessionRemember', 'true');
    }
    ...
    function resetInactivityTimer() {
        ...
        inactivityTimer = setTimeout(function() {
            ...
            if (!rememberMe) {
                clearSessionCredentials();
                console.log('Session credentials cleared due to inactivity');
            }
        }, 30 * 60 * 1000);
    }
