            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5">
                    <div class="role-cards d-flex gap-3 justify-content-center flex-column flex-md-row">
                        ...
                        {{-- Card 2 --}}
                        <label class="role-card selected" tabindex="0" data-role="{{ $thirdRole }}">
                            <input type="radio" name="role" value="{{ $thirdRole }}" class="d-none" />
                    ...
                    <div class="d-flex flex-column align-items-center mt-4">
                        ...
                        <a id="joinBtn" 
                        href="{{ route('register', ['role' => $thirdRole]) }}" 
                        class="btn btn-success btn-join px-4 py-2">
                        Join as a {{ ucfirst($thirdRole) }}
                        </a>
                    </div>
                    <br>
